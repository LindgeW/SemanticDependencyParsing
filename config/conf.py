...
def args_config():
    ...
    parse.add_argument('--data_type', choices=['news', 'text'], default='news', help='the dataset type')
    ...
    parse.add_argument('--wd_embed_dim', type=int, default=100, help='feature size of source inputs')
    ...
    parse.add_argument('--arc_size', type=int, default=512, help='feature size of char inputs')
    parse.add_argument('--rel_size', type=int, default=512, help='feature size of char inputs')
    parse.add_argument('--rel_loss_ratio', type=int, default=0.025, help='feature size of char inputs')
    ...
    parse.add_argument('--rnn_depth', type=int, default=3, help='number of rnn layers')
    ...
    parse.add_argument('--arc_drop', type=float, default=0.25, help='drop rate of dep arc')
    parse.add_argument('--rel_drop', type=float, default=0.25, help='drop rate of dep rel')
    parse.add_argument('--dropout', type=float, default=0.25, help='dropout ratio')
